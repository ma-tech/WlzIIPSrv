...
\hypersetup{
    ...
    pdffitwindow=false,
    pdfstartview={FitH},
    pdftitle={The Woolz Internet Image Protocol (IIP) Server (Version 1.1.5)},
    pdfauthor={Bill Hill},
...
\hline
background\verb=(=\emph{exp},\emph{value}\verb=)=                   & Sets the background value (value outside the
...
domain\verb=(=\emph{exp}\verb=)=                                    & The domain of the expresion's object. \\
erosion\verb=(=\emph{exp},\emph{radius}\verb=)=                     & The erosion of the domain by \emph{radius}\ voxels. \\
fill\verb=(=\emph{exp}\verb=)=                                      & Fills all holes not connected to the outside in the
...
setvalue\verb=(=\emph{exp},\emph{value}\verb=)=                     & Creates an object with the domain of the given
...
transfer\verb=(=\emph{exp},\emph{exp}\verb=)=                        & Creates a new object with the domain of the first
...
union\verb=(=\emph{exp list}\verb=|=\emph{idx list},
             \emph{exp list}\verb=|=\emph{idx list}\verb=)=         & The union of the domains in the given lists. \\
\hline
\end{tabular}
