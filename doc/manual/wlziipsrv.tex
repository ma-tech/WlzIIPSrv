...
indices and the image processing operators. Three of the
image processing operators (intersection, occupancy and union) may
...
\emph{exp}         	&:=& \emph{idx}\verb=)|= \\
	    ...
	    &  & occupancy\verb=(=\emph{exp list}\verb=?) |= \\
...
occupancy\verb=(=\emph{exp list}\verb=?)=                           & The domain occupancy in the optional list. \\
